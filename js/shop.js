...
(function ($) {
  ...
  const products = [
    { id: 1, category: 'crocks', title: 'Stone Creek Ceramic Crock (5L)', price: 125, rating: 5, img: 'https://rukminim2.flixcart.com/image/480/640/xif0q/container/p/u/9/ceramic-jars-1000ml-brown-kutting-jar-hc-the-crafts-original-imagxjv7dvfsxcye.jpeg?q=90', badge: 'Artisan Made', desc: 'Handcrafted stoneware with a deep water seal for perfect anaerobic fermentation.' },
    { id: 2, category: 'crocks', title: 'Modern Minimalist Crock (2L)', price: 65, rating: 4, img: 'https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=600&q=80', badge: 'Top Seller', desc: 'Sleek design that looks beautiful on any countertop. Perfect for small batches.' },
    ...
    { id: 4, category: 'jars', title: 'Glass Fermentation Weights', price: 18, rating: 5, img: 'https://countrytradingco.com.au/cdn/shop/products/ferementing-glass-weights_600x.jpg?v=1655161657', badge: 'Must Have', desc: 'Keep your veggies submerged below the brine to prevent mold. Lead-free glass.' },
    ...
    { id: 7, category: 'tools', title: 'Hardwood Kraut Tamper', price: 28, rating: 5, img: 'https://tse1.explicit.bing.net/th/id/OIP.kBS9fZGq7DjM7K0CgwqgnQHaE6?rs=1&pid=ImgDetMain&o=7&rm=3', badge: 'Handmade', desc: 'Ergonomic tool for pounding cabbage and packing jars tightly. Solid beechwood.' },
    { id: 8, category: 'pantry', title: 'Himalayan Pink Salt (1kg)', price: 14, rating: 5, img: 'https://tse1.mm.bing.net/th/id/OIP.dgR_16iFWNLiTrhZAO73iAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3', badge: 'Pure', desc: 'Mineral-rich salt without iodine or anticaking agents. The best salt for brine.' },
    { id: 9, category: 'pantry', title: 'Artisan Gochugaru (250g)', price: 19, rating: 5, img: 'https://colmadosingular.com/wp-content/uploads/2024/08/FC087_068_OK.jpg', badge: 'Korean Grown', desc: 'Sun-dried red pepper flakes with the perfect balance of heat and smokiness for kimchi.' },
  ];
